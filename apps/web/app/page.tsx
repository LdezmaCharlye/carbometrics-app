...
<section className="normas" id="normas">
  <div className="normas-inner">
    <div>
      <span className="sec-tag rv">Normativa</span>
      <h2 className="sec-title rv">Trabajamos con las<br/><em>normas internacionales</em><br/>más exigentes.</h2>
      <p className="sec-sub rv">Nuestros productos están construidos sobre las metodologías reconocidas globalmente para la medición y gestión de huellas ambientales: gases de efecto invernadero y recursos hídricos.</p>
      <div className="normas-badges rv">
        <div className="norma-badge">
          <div className="norma-badge-dot"></div>
    ...
    <div className="normas-right">
      ...
      <div className="norma-card rv d1">
      ...
      <div className="norma-card is-water rv">
      ...
      <div className="norma-card is-water rv d1">
...
<section className="section" style={{background: 'var(--gray)'}} id="planes">
  <div className="inner center">
    <span className="sec-tag rv">Tarifas</span>
    <h2 className="sec-title rv">Planes Disponibles</h2>
    <p className="sec-sub rv">Selecciona el nivel de gestión ambiental que tu organización necesita hoy.</p>
    <div className="plans-grid">
      <div className="plan rv">
        ...
        <a href="https://www.carbometrics.site/login" className="btn-plan">Seleccionar Plan</a>
      </div>
      ...
      <div className="plan rv d2">
        ...
        <a href="#contacto" className="btn-plan">Contactar Ventas</a>
      </div>
    </div>
  </div>
</section>
...
<section className="section" id="faq">
  <div className="inner center">
    ...
    <h2 className="sec-title rv">Resolviendo tus dudas</h2>
    <div className="faq-wrap rv">
      <div className="faq-item">
        <button className="faq-btn" type="button">
          <span className="faq-q">¿Qué diferencias hay entre CarboMetrics e HydroMetrics?</span>
          <span className="faq-icon"><svg viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg></span>
        </button>
        <div className="faq-body">CarboMetrics se especializa en el inventario y reporte de gases de efecto invernadero (huella de carbono). HydroMetrics evalúa los volúmenes consumidos y degradados de agua (huella hídrica).</div>
      </div>
      <div className="faq-item">
        <button className="faq-btn" type="button">
          <span className="faq-q">¿Los reportes son válidos para auditorías de certificación?</span>
          <span className="faq-icon"><svg viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg></span>
        </button>
        <div className="faq-body">Sí, toda la estructura de datos y los reportes generados siguen estrictamente los lineamientos exigidos por las normas ISO 14064-1 e ISO 14046.</div>
      </div>
    </div>
  </div>
</section>
...
<section className="section" style={{background: 'var(--gray)'}} id="contacto">
  <div className="contact-inner">
    <div>
      <span className="sec-tag rv">Comunicación</span>
      <h2 className="sec-title rv">¿Tienes preguntas?<br/>Contáctanos</h2>
      <p className="sec-sub rv" style={{margin: '0 0 24px 0'}}>Estamos listos para guiarte en el proceso de implementación ambiental en tu empresa.</p>
      <div className="contact-items rv">
        <div className="ci">
          <div className="ci-icon"><svg viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg></div>
          <div><strong>Teléfono</strong><span>+591 (4) 400-0000</span></div>
        </div>
        <div className="ci">
          <div className="ci-icon"><svg viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><path d="M22 6l-10 7L2 6"/></svg></div>
          <div><strong>Correo</strong><span>soporte@carbometrics.site</span></div>
        </div>
      </div>
    </div>
    <div className="contact-form rv d1">
      <div className="form-group">
        ...
        <input type="text" id="cName" placeholder="Ej. Juan Pérez" required />
      </div>
      <div className="form-group">
        <label htmlFor="cEmail">Correo electrónico corporativo</label>
        <input type="email" id="cEmail" placeholder="juan@empresa.com" required />
      </div>
      <div className="form-group">
        <label htmlFor="cMsg">Mensaje o consulta</label>
        <textarea id="cMsg" placeholder="Cuéntanos sobre las necesidades de tu empresa..." required></textarea>
      </div>
      <button type="button" className="btn-submit" id="submitBtn">Enviar mensaje →</button>
    </div>
  </div>
</section>
...
<section className="cta-band">
  <h2 className="rv">Automatiza tu contabilidad ambiental hoy</h2>
  <p className="rv d1">Únete a las empresas que lideran la transición hacia un modelo operativo sostenible.</p>
  <div className="rv d2"><a href="https://www.carbometrics.site/login" className="btn-white">Crear cuenta corporativa</a></div>
</section>
  ...
  <div className="inner">
    <div className="footer-top">
      <div className="footer-brand">
        <div className="footer-logo">Carbo<span>Métrica</span></div>
        <p>Tecnología avanzada para la gestión, medición y reporte del impacto ambiental empresarial.</p>
        <div className="footer-tags">
          <span className="footer-tag">SaaS</span>
          <span className="footer-tag">Carbon footprint</span>
          <span className="footer-tag">Water footprint</span>
        </div>
      </div>
